package com.sample.fp.fingerprintsample;
...
import com.fp.common.AuthErrorCodes;
import com.fp.common.FingerPrintAuthCallback;
import com.fp.common.FingerPrintAuthHelper;
import com.fp.common.FingerPrintUtils;
...
public class MainActivity extends AppCompatActivity implements FingerPrintAuthCallback {
    ...
    public void onNoFingerPrintHardwareFound() {
        mAuthMsgTv.setText("Your device does not have finger print scanner. Please type password/screenlock to authenticate.");
        mSwitcher.showNext();
    }
